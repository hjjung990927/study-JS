...
// slice(begin, end): 원하는 부분을 추출하기 위해 시작(포함) 인덱스를 전달하면, 끝까지 추출한다.
...
// let result = getTotal(1, 2, 3, 4, 5, 6, 7);
// console.log(result);
...
// console.log(datas.lastIndexOf(3));
...
// 기존 값을 두 배 증가시키기
// let datas = new Array(10, 9, 8, 7, 6);
